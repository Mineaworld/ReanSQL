    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-4">
          <span className="text-sm text-gray-600 dark:text-gray-400">{currentIdx + 1} / {questions.length}</span>
        ...
        <div className="flex-1 flex flex-col gap-2 overflow-y-auto mb-4">
          {questions.map((q, idx) => (
            <button
              ...
              className={`text-left px-4 py-2 rounded-lg transition-all font-medium border shadow-sm
                ${idx === currentIdx
                  ...
                  : 'bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 hover:bg-blue-200 dark:hover:bg-blue-900 cursor-pointer hover:shadow-md'}
              `}
